        ...
        <div className="space-y-8 relative font-sans text-zinc-900">
            ...
            <div>
                <input
                    ...
                    className="w-full sm:w-96 rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm text-zinc-900 placeholder-zinc-400 focus:border-[#d9a05b] focus:outline-none focus:ring-1 focus:ring-[#d9a05b] shadow-sm transition-all"
                />
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredLore.map((lore: LoreItem) => (
                        <div
                            ...
                            className="rounded-2xl border border-zinc-200 bg-white p-6 hover:border-amber-400/60 hover:-translate-y-1 transition-all duration-300 shadow-sm group cursor-pointer hover:shadow-md relative flex flex-col h-full"
                        >
                    ...
                    >
                        <div className="flex justify-between items-center p-6 border-b border-zinc-100 bg-zinc-50 shrink-0">
                            <div className="flex items-center gap-4">
                                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#081B21] shadow-inner">
                                    {/* Need a slightly larger icon for the modal header */}
                                ...
                                <div>
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 border border-zinc-200 bg-white px-2 py-0.5 rounded-md shadow-sm">
                        ...
                        <div className="overflow-y-auto p-6 md:p-8 flex-1 custom-scrollbar bg-[#FAF6ED]/30">
                            {selectedLore.summary && (
                                <div className="mb-8 p-5 bg-white border border-zinc-200 shadow-sm rounded-2xl">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
                    <div className="w-full max-w-2xl rounded-3xl border border-zinc-200 bg-white shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
                        <div className="flex justify-between items-center p-6 border-b border-zinc-100 bg-zinc-50 shrink-0">
                            ...
                            <form id="create-lore-form" onSubmit={handleCreate} className="space-y-6">
                                ...
                                <div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            {backupContent ? (
                                                <button
                                                    ...
                                                    className="text-[10px] font-bold uppercase tracking-wider text-red-600 hover:text-red-700 px-3 py-1.5 bg-red-50 border border-red-200 rounded-lg transition-colors cursor-pointer"
                                                >
                                                    Undo AI Changes
                                                </button>
                                            ) : (
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-indigo-700 hover:text-indigo-800 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-lg transition-colors disabled:opacity-50 cursor-pointer shadow-sm"
                                                >
                                    ...
                                    <div className="relative">
                                        {isEnhancing && (
                                            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm rounded-xl border border-indigo-200 transition-all duration-300">
                                        ...
                                        <textarea
                                            ...
                                            className="block w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-zinc-900 placeholder-zinc-400 focus:border-[#d9a05b] focus:outline-none focus:ring-1 focus:ring-[#d9a05b] text-sm resize-y min-h-[250px] shadow-sm disabled:bg-zinc-50 custom-scrollbar"
                        ...
                        <div className="p-6 border-t border-zinc-100 bg-white shrink-0 flex justify-end gap-3 rounded-b-3xl">
                            <button
                                type="button"
                                onClick={handleCloseModal}
                                className="rounded-xl px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 transition-colors cursor-pointer"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="flex items-center justify-center min-w-[120px] rounded-xl bg-[#0F2C24] hover:bg-[#153b30] px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white disabled:opacity-50 transition-colors shadow-md cursor-pointer"
                            >
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
                    <div className="w-full max-w-sm rounded-2xl border border-red-100 bg-white p-6 shadow-2xl overflow-hidden relative">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="font-serif text-lg font-bold text-zinc-900 leading-tight">Delete Lore Entry?</h3>
