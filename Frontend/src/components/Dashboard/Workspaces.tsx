...
export default function Workspaces() {
    ...
    if (loading) {
        return (
            <div className="flex min-h-screen bg-[#FAF6ED] items-center justify-center font-mono text-zinc-500 font-medium text-xs tracking-widest uppercase">
        ...
        return (
            <div className="flex min-h-screen bg-[#FAF6ED] items-center justify-center p-4">
                ...
                >
                    ...
                    <p className="font-sans text-sm text-zinc-600">{error.message}</p>
                </motion.div>
            </div>
        );
    }
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col gap-10">
                ...
                >
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            {/* CREATOR NAME: font-serif */}
                            <h1 className="font-serif text-2xl md:text-3xl font-bold text-zinc-900 mb-2">
                                {creatorName}
                            </h1>
                            {/* ROLE BADGE: font-mono */}
                            <span className="font-mono inline-flex items-center gap-1.5 bg-white border border-zinc-200 px-2.5 py-1 rounded-lg font-bold text-[10px] uppercase tracking-widest text-zinc-700 shadow-sm">
                    ...
                    <div className="bg-white border border-zinc-200 rounded-xl p-4 min-w-[140px] shadow-sm flex flex-col justify-center">
                        <div className="flex justify-between items-center mb-1">
                            ...
                            {/* REALM COUNT: font-serif */}
                            <div className="font-serif text-xl font-bold text-zinc-900">{workspaces.length}</div>
                        </div>
                        {/* TOTAL REALMS LABEL: font-mono */}
                        <div className="font-mono text-[10px] font-bold text-zinc-400 uppercase tracking-widest text-right mt-1">Total Realms</div>
                    </div>
                </motion.div>
                                        ...
                                        <div>
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {workspace.isPublic ? (
                                                        <span className="font-mono flex items-center gap-1 px-2 py-0.5 bg-emerald-50 text-emerald-700 font-bold text-[9px] uppercase tracking-wider rounded-md border border-emerald-100">
                                                            <Globe className="w-3 h-3" /> Public
                                                        </span>
                                                    ) : (
                                                        <span className="font-mono flex items-center gap-1 px-2 py-0.5 bg-zinc-50 text-zinc-600 font-bold text-[9px] uppercase tracking-wider rounded-md border border-zinc-200">
