...
export const DashboardLayout = () => {
    ...
    return (
        <div className="flex min-h-screen bg-black text-zinc-100 overflow-x-hidden">
            {/* Mobile Menu Button */}
            ...
            {/* Main Content Area */}
            <main className="flex-1 min-h-screen bg-black relative flex flex-col">
                <div className="flex-1 w-full p-6 md:p-10 pt-20 md:pt-10">
                    <Outlet />
                </div>
            </main>
