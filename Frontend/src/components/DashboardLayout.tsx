...
export const DashboardLayout = () => {
    ...
    return (
        <div className="flex min-h-screen bg-[#FAF6ED] text-zinc-800 font-sans selection:bg-amber-200 selection:text-black overflow-hidden relative">
            ...
            {/* Mobile Menu Button - Clean Style */}
            ...
            `}>
                ...
                <div className="p-4 border-t border-zinc-100 shrink-0 bg-white">
                    <button
                        ...
                        className="flex items-center justify-center gap-2.5 w-full px-4 py-2.5 border border-zinc-200 text-xs font-bold tracking-wider uppercase text-zinc-600 hover:text-red-600 hover:border-red-200 hover:bg-red-50/50 transition-colors rounded-xl shadow-sm"
                    >
