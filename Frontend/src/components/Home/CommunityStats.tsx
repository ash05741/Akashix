                ...
                >
                    ...
                    <div className="relative z-10 p-8 lg:p-14 grid grid-cols-[1fr_1.8fr] gap-8 lg:gap-12 items-center">
                        ...
                        <div className="pr-0 lg:pr-4">
                            ...
                            <button className="group flex items-center gap-3 border border-[#D4B976]/40 hover:border-[#D4B976]/80 hover:bg-[#D4B976]/10 text-zinc-100 px-6 py-2.5 rounded-lg text-sm font-medium w-fit transition-all duration-300 cursor-pointer">
